...
public class PageWriter {
	...
	/* Reads the Network and creates the Applications page. */
	private void generateApplicationsPage() {
		// Reading the HTML template
		String html = Utils.fileToString("./resources/Template.Applications.html");


		html = html.replace("@date", (new Date()).toString());

		// Writing the HTML page
		Utils.stringToFile("./page/Applications.html", html);
	}
	...
	private void generateOntologyPage(Ontology onto) {
		...
		String svgstar1 = "<i class=\"bi bi-quote\"></i>";
		String svgstar2 = "<i class=\"bi bi-quote\"></i>";
		String svgstar3 = "<i class=\"bi bi-quote\"></i>";
